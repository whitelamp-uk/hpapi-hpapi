...
BEGIN
  IF ((SELECT COUNT(`id`) FROM `hpapi_user`) = 0) THEN
    ...
    (3,	1,	'caf791cb-d224-11e8-956a-00165e0004e8',	'89c56ad8-8ff3-11e8-902b-001f16148bc1',	0,	0,	'0000-00-00 00:00:00',	'^.*$',	'Example field staff',	'Example lower-level field staff member',	'test.1@no.where',	1,	'',	1,	'$2y$10$hLSdApW6.30YLK3ze49uSu7OV0gmS3ZT65pufxDPGiMxsmW3bykeq');
