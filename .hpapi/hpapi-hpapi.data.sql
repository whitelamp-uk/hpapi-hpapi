...
INSERT INTO `hpapi_call` (`call_Model`, `call_Spr`, `call_Vendor`, `call_Package`, `call_Class`, `call_Method`) VALUES
...
INSERT INTO `hpapi_email` (`email_Verified`, `email_Email`, `email_User_UUID`) VALUES
...
INSERT INTO `hpapi_key` (`key_Expired`, `key_Key`, `key_Remote_Addr_Pattern`, `key_User_UUID`, `key_Vendor`, `key_Package`) VALUES
...
INSERT INTO `hpapi_node` (`node_Node`, `node_Name`) VALUES
('paddy',	'Mark\'s laptop');

INSERT INTO `hpapi_package` (`package_Vendor`, `package_Package`, `package_Notes`) VALUES
...
INSERT INTO `hpapi_run` (`run_Usergroup`, `run_Vendor`, `run_Package`, `run_Class`, `run_Method`) VALUES
...
INSERT INTO `hpapi_user` (`user_Active`, `user_UUID`, `user_Notes`, `user_Give_Diagnostic`, `user_Name`, `user_Password_Hash`) VALUES
